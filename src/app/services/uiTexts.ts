...
export const uiTexts = {
  ...
  start_ikl_subheadline: 'Du willst, dass es weiterhin all die Geschäfte gibt, die Deine Stadt ausmachen?' + '<br />Du kannst etwas dafür tun!',
  start_ikl_text:
  ...
  start_presse_1_title: 'Dies Projekte helfen Geschäften und Restaurants in der Corona-Krise',
  start_presse_1_content:
    'Fast alle Geschäfte sind geschlossen. Bars oder Cafés müssen Wege finden, trotz Corona Umsätze ' + 'zu erzielen. Hilfe bekommen sie von Kreativen und Digitalexperten. Einige sind einem Aufruf der Regierung gefolgt.',
  start_presse_1_link: 'https://www.welt.de/wirtschaft/gruenderszene/article206873211/Corona-Krise-Diese-Projekte-helfen-Geschaeften-und-Restaurants.html',
  start_presse_2_date: '29.03.2020',
  start_presse_2_title: 'Läden geschlossen – und jetzt? Was Händler tun können!',
  start_presse_2_content:
    'Handel muss nicht zwangsläufig in einem Ladengeschäft stattfinden – diese Erkenntnis ist während der ' + 'Corona-Krise notwendiger denn je.  Schon mehr als jeder zweite Einzelhändler bietet seine Produkte bereits online an.',
  start_presse_2_link: 'https://www.bitkom.org/Themen/Corona/Handel',
  start_presse_3_date: '23.07.2020',
  start_presse_3_title: '#WirVsVirus – the world’s biggest online hackathon – the nine teams selected for its Solution Builder',
  start_presse_3_content: 'We caught up with representatives from three of these fledgling organisations: lokalkauf; quarano; and RemedyMatch, to hear ' + 'about their innovative solutions to COVID-19-related problems.',
  start_presse_3_link: 'https://berlin.impacthub.net/wirvsvirus-solutionbuilder/',
  ...
  testimonal_1_testimonial: 'Es gibt Berge, über die man hinüber muss, sonst geht der Weg nicht weiter (Ludwig Thoma) ' + ' – Danke an lokalkauf für die großartige Unterstützung!',
  testimonal_2_testee: 'Achim Düster, Düster Herrenmoden, Brühl',
  testimonal_2_testimonial: 'Lokalkauf gefällt mir sehr gut. Vor allem die einfache Bedienung' + ' für mich als Händler und für meine Kunden finde ich gelungen.',
  textSearch_placeholder: 'Händlersuche',
  start_searchbottom_headline: 'Überzeugt? <br />Dann entdecke unsere Händler und Geschäfte!',
  licence_odbl_general_text: 'Diese Daten stehen unter Open Data Commons Open Database Lizenz, ',
